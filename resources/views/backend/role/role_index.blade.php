    ...
    <div class="row justify-content-between">
        <div class="col-md-4 mt-1">
            <div class="mt-3 mt-md-0">
                <h4 class="page-title-main page">User Access</h4>
            </div>
        </div><!-- end col-->
        <div class="col-md-8 mt-3 d-flex flex-wrap align-items-center justify-content-sm-end">
            <a href="{{ url('/super-admin/role/create') }}" type="button" class="btn btn-primary waves-effect waves-light button-color"><i
