    ...
    <div class="row justify-content-between">
        <div class="col-md-4 mt-1">
            <div class="mt-3 mt-md-0">
                <h4 class="page-title-main page">Admin</h4>
            </div>
        </div><!-- end col-->
        <div class="col-md-8 mt-3 d-flex flex-wrap align-items-center justify-content-sm-end">
            <a href="{{ url('/super-admin/user/create') }}" type="button" class="btn btn-primary waves-effect waves-light button-color"><i
    ...
    @push('footer_content')
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var currentURLKey = urlData.split('/')[3];
                var table = $('.data-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ url('/super-admin/user') }}",
                    order: [
                        [0, 'desc']
                    ],
                    columnDefs: [{
