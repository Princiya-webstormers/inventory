	...
	<div>
		<small>Showing {{$start}} - {{$end}} of {{$total}}</small>
  	    ...
  	    @if($paginator->onFirstPage())
  			<li class="page-item"><a class="page-link disabled text-decoration-none" ><i class="fa fa-chevron-left"></i></a></li>
  		@else
	            			...
	            			@if ($i<$max)
		            			...
		            			@if ($page >= $start)
			            			@if ($page == $paginator->currentPage())
				                        <li class="page-item"><a class="page-link text-decoration-none" >{{ $page }}</a></li>
				                    @else
        ...
        @if($paginator->hasMorePages())
    		<li class="page-item"><a class="page-link text-decoration-none" href="{{$paginator->nextPageUrl()}}"><i class="fa fa-chevron-right" ></i></a></li>
    	@else
    		<li class="page-item"><a class="page-link disabled" ><i class="fa fa-chevron-right" ></i></a></li>
    	@endif
  		</ul>
	</nav>
@endif